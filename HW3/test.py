...
class PolynomialTestCase(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.Penalty = {'libraries':100,'authors':100,'c':50,'w':20,'s':20}
        cls.Points = {x:4 for x in "bcdefghijklmnopqrstuvw"}
        cls.Points['w'] = 2
        cls.Points['s'] = 2
        cls.Points['j'] = 6
        cls.Points['o'] = 7
        ...
        cls.refcode = {'lines':50,'words':163}
        cls.msgs=[]
    ...
    def test_init(self):
        ...
        empty_q = Polynomial()
        z = Polynomial([])
        self.Points['b']=self.MaxPoints['b']
    ...
    def test_eq(self):
        ...
        self.Points['c']=self.MaxPoints['c']
    ...
    def test_eval(self):
        ...
        self.Points['d']=self.MaxPoints['d']
    ...
    def test_add(self):
        ...
        self.Points['e']=self.MaxPoints['e']
    ...
    def test_add_consistent(self):
        ...
        self.Points['f']=self.MaxPoints['f']
    ...
    def test_uneven_add(self):
        ...
        self.Points['g']=self.MaxPoints['g']
    ...
    def test_subtract(self):
        ...
        self.Points['h']=self.MaxPoints['h']
    ...
    def test_uneven_sub(self):
        ...
        self.Points['i']=self.MaxPoints['i']
    ...
    def test_floating(self):
        ...
        self.Points['j']=self.MaxPoints['j']
    ...
    def test_Mul(self):
        ...
        self.Points['k']=self.MaxPoints['k']
    ...
    def test_UnevenMul(self):
        ...
        self.Points['l']=self.MaxPoints['l']
    ...
    def test_Get(self):
        ...
        self.Points['m']=self.MaxPoints['m']
    ...
    def test_Get_missing_value(self):
        ...
        self.Points['n']=self.MaxPoints['n']
    ...
    def test_Neg_sub(self):
        ...
        self.Points['o']=self.MaxPoints['o']
    ...
    def test_complex(self):
        ...
        self.Points['p']=self.MaxPoints['p']
    ...
    def test_derivative_pos(self):
        ...
        self.Points['q']=self.MaxPoints['q']
    ...
    def test_derivative_neg(self):
        ...
        self.Points['r']=self.MaxPoints['r']
    ...
    def test_Limits(self):
        ...
        self.Points['s']=self.MaxPoints['s']
    ...
    def test_speed(self):
        ...
        self.Points['t']=self.MaxPoints['t']
    ...
    def test_sparse(self):
        ...
        if multiply_time>0.0001:
            self.fail("Your multiply is not efficient")
        self.Points['u']=self.MaxPoints['u']
    ...
    def test_add_long(self):
        ...
        self.Points['v']=self.MaxPoints['v']
    ...
    def test_nomods(self):
        ...
        self.Points['w']=self.MaxPoints['w']
...
testcases={
'hw3_model_poly.py':PolynomialTestCase,
}


if __name__ == '__main__':
    s= f' ({hw} Modeling Checker Version {VERSION[0]}.{VERSION[1]})'
    g={}
